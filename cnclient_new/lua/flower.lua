...
--------------------------------------------------------------------------------
function M.openWindow(title, width, height, world_width, world_height, x_offset, y_offset)
    width = width or M.DEFAULT_SCREEN_WIDTH
    height = height or M.DEFAULT_SCREEN_HEIGHT
    
    M.updateDisplaySize(width, height, world_width, world_height, x_offset, y_offset)
...
-- @param scale (Option)Scale of the Viewport to the Screen
--------------------------------------------------------------------------------
function M.updateDisplaySize(width, height, world_width, world_height, x_offset, y_offset)
    M.screenWidth = width
    M.screenHeight = height
    M.viewWidth = world_width or width
    M.viewHeight = world_height or height
	M.viewXOffset = x_offset or 0
	M.viewYOffset = y_offset or 0
    
    M.viewport = M.viewport or MOAIViewport.new()
    M.viewport:setSize(M.viewXOffset, M.viewYOffset, M.viewXOffset + M.screenWidth, M.viewYOffset + M.screenHeight)
