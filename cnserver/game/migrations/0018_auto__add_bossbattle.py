...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BossBattle'
        db.create_table(u'game_bossbattle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('boss', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Player'])),
            ('unlocked_at', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'game', ['BossBattle'])


    def backwards(self, orm):
        # Deleting model 'BossBattle'
        db.delete_table(u'game_bossbattle')
    ...
    models = {
        ...
        u'game.bossbattle': {
            'Meta': {'object_name': 'BossBattle'},
            'boss': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['game.Player']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'unlocked_at': ('django.db.models.fields.IntegerField', [], {})
        },
