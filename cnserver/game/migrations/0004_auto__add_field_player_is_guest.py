...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.is_guest'
        db.add_column('game_player', 'is_guest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.is_guest'
        db.delete_column('game_player', 'is_guest')
    ...
    models = {
        ...
        'game.player': {
            ...
            'last_played_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 26, 0, 0)'}),
