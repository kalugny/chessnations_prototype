...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Nation'
        db.create_table(u'game_nation', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, primary_key=True)),
            ('leader_img', self.gf('django.db.models.fields.files.ImageField')(max_length=255)),
        ))
        db.send_create_signal(u'game', ['Nation'])

        # Adding field 'Player.nation'
        db.add_column(u'game_player', 'nation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Nation'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Nation'
        db.delete_table(u'game_nation')

        # Deleting field 'Player.nation'
        db.delete_column(u'game_player', 'nation_id')
    ...
    models = {
        ...
        u'game.nation': {
            ...
            'leader_img': ('django.db.models.fields.files.ImageField', [], {'max_length': '255'}),
        ...
        u'game.player': {
            ...
            'last_played_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 6, 0, 0)'}),
