...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EndGameAward.outcome'
        db.alter_column('game_endgameaward', 'outcome', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'EndGameAward.outcome'
        db.alter_column('game_endgameaward', 'outcome', self.gf('django.db.models.fields.CharField')(max_length=10))
