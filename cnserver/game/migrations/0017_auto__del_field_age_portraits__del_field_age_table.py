...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Age.portraits'
        db.delete_column(u'game_age', 'portraits')

        # Deleting field 'Age.table'
        db.delete_column(u'game_age', 'table')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Age.portraits'
        raise RuntimeError("Cannot reverse this migration. 'Age.portraits' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Age.table'
        raise RuntimeError("Cannot reverse this migration. 'Age.table' and its values cannot be restored.")
