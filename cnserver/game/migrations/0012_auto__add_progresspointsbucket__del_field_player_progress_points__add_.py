...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('game_progresspointsbucket', (
        ...
        db.send_create_signal('game', ['ProgressPointsBucket'])

        # Deleting field 'Player.progress_points'
        db.delete_column('game_player', 'progress_points')

        # Adding field 'Player.progress_points_in_bucket'
        db.add_column('game_player', 'progress_points_in_bucket',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Player.progress_points_bucket'
        db.add_column('game_player', 'progress_points_bucket',
        ...
        db.add_column('game_player', 'total_progress_points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('game_progresspointsbucket')

        # Adding field 'Player.progress_points'
        db.add_column('game_player', 'progress_points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Player.progress_points_in_bucket'
        db.delete_column('game_player', 'progress_points_in_bucket')

        # Deleting field 'Player.progress_points_bucket'
        db.delete_column('game_player', 'progress_points_bucket_id')

        # Deleting field 'Player.total_progress_points'
        db.delete_column('game_player', 'total_progress_points')
    ...
    models = {
        ...
        'game.player': {
            ...
            'last_played_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 11, 0, 0)'}),
