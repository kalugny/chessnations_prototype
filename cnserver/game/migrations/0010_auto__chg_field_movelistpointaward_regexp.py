...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MoveListPointAward.regexp'
        db.alter_column('game_movelistpointaward', 'regexp', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'MoveListPointAward.regexp'
        db.alter_column('game_movelistpointaward', 'regexp', self.gf('django.db.models.fields.CharField')(max_length=50))
