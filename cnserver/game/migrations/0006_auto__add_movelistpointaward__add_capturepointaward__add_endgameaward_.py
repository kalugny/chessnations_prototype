...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MoveListPointAward'
        db.create_table('game_movelistpointaward', (
            ('pointaward_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['game.PointAward'], unique=True, primary_key=True)),
            ('regexp', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('is_rule_only_for_last_move', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('game', ['MoveListPointAward'])

        # Adding model 'CapturePointAward'
        db.create_table('game_capturepointaward', (
            ('pointaward_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['game.PointAward'], unique=True, primary_key=True)),
            ('captured_piece', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('game', ['CapturePointAward'])

        # Adding model 'EndGameAward'
        db.create_table('game_endgameaward', (
            ('pointaward_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['game.PointAward'], unique=True, primary_key=True)),
            ('outcome', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('game', ['EndGameAward'])

        # Adding model 'PointAward'
        db.create_table('game_pointaward', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('points', self.gf('django.db.models.fields.IntegerField')()),
            ('square', self.gf('django.db.models.fields.CharField')(max_length=4, null=True)),
        ))
        db.send_create_signal('game', ['PointAward'])


    def backwards(self, orm):
        # Deleting model 'MoveListPointAward'
        db.delete_table('game_movelistpointaward')

        # Deleting model 'CapturePointAward'
        db.delete_table('game_capturepointaward')

        # Deleting model 'EndGameAward'
        db.delete_table('game_endgameaward')

        # Deleting model 'PointAward'
        db.delete_table('game_pointaward')
    ...
    models = {
        ...
        'game.pointaward': {
            ...
            'square': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True'})
        }
    }
