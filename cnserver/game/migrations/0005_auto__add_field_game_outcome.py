...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.outcome'
        db.add_column('game_game', 'outcome',
                      self.gf('django.db.models.fields.CharField')(default='undecided', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.outcome'
        db.delete_column('game_game', 'outcome')
    ...
    models = {
        ...
        'game.player': {
            ...
            'last_played_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 28, 0, 0)'}),
