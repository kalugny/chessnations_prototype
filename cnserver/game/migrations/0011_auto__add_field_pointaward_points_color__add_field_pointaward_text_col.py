...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PointAward.points_color'
        db.add_column('game_pointaward', 'points_color',
                      self.gf('django.db.models.fields.CharField')(default='D4A017', max_length=6),
                      keep_default=False)

        # Adding field 'PointAward.text_color'
        db.add_column('game_pointaward', 'text_color',
                      self.gf('django.db.models.fields.CharField')(default='8A4117', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PointAward.points_color'
        db.delete_column('game_pointaward', 'points_color')

        # Deleting field 'PointAward.text_color'
        db.delete_column('game_pointaward', 'text_color')
    ...
    models = {
        ...
        'game.player': {
            ...
            'last_played_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 0, 0)'}),
            'logged_in': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'progress_points': ('django.db.models.fields.IntegerField', [], {}),
